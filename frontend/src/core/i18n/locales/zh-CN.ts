...
export const zhCN: Translations = {
  ...
  welcome: {
    ...
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来扩展 AI Tool Research 的能力。通过自定义技能，系统\n可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n网页等作品。",
  },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在系统中使用",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription: "使用键盘快捷键更快地操作 AI Tool Research。",
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 AI Tool Research 的界面和行为。",
    sections: {
      account: "账号",
      appearance: "外观",
      memory: "记忆",
